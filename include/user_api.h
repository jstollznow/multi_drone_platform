 ...
 */
void set_drone_velocity(const mdp_api::id& id, mdp_api::velocity_msg msg);
 ...
 */
velocity_data get_velocity(const mdp_api::id& id);
 ...
 */
void set_drone_position(const mdp_api::id& id, mdp_api::position_msg msg);
 ...
 */
position_data get_position(const mdp_api::id& id);
 ...
 */
void cmd_takeoff(const mdp_api::id& id, float height = 0.5f, float duration = 2.0f);
 ...
 */
void cmd_land(const mdp_api::id& id, float duration = 2.0f);
 ...
 * @param id the id of the subject drone
 */
void cmd_emergency(const mdp_api::id& id);
 ...
 */
void cmd_hover(const mdp_api::id& id, float duration = 10.0f);
 ...
 * @see go_to_home
 */
void set_home(const mdp_api::id& id, mdp_api::position_msg msg);
 ...
 */
position_data get_home(const mdp_api::id& id);
 ...
 */
void go_to_home(const mdp_api::id& id, float duration = 4.0f, float height = -1.0f);
 ...
 * @param id the id of the subject drone
 */
void sleep_until_idle(const mdp_api::id& id);
